...
<html lang="en" dir="ltr">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/vendor/photoswipe/photoswipe.css" />
        <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/vendor/photoswipe/default-skin/default-skin.css" />
        <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/vendor/select2/css/select2.min.css" />
        <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/style.css" />
        <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/style.header-spaceship-variant-one.css" media="(min-width: 1200px)" />
        <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/style.mobile-header-variant-one.css" media="(max-width: 1199px)" /> -->
        <!-- font - fontawesome -->
        <!-- <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/vendor/fontawesome/css/all.min.css" /> -->
                    ...
                    <div class="header__topbar-end">
                        <div class="topbar topbar--spaceship-end">
                            <div class="topbar__item-button">
                                <a href="#" class="topbar__button"><span class="topbar__button-label">Compare:</span> <span class="topbar__button-title">5</span></a>
                            </div>
                            <div class="topbar__item-button topbar__menu">
                                ...
                                <div class="topbar__menu-body">
                                    <a class="topbar__menu-item" href="#">€ Euro</a> <a class="topbar__menu-item" href="#">£ Pound Sterling</a> <a class="topbar__menu-item" href="#">$ US Dollar</a>
                            ...
                            <div class="topbar__menu">
                                ...
                                <div class="topbar__menu-body">
                                    <a class="topbar__menu-item" href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/languages/language-1.png" alt="" /><span>English</span> </a>
                                    <a class="topbar__menu-item" href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/languages/language-2.png" alt="" /><span>French</span> </a>
                                    <a class="topbar__menu-item" href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/languages/language-3.png" alt="" /><span>German</span> </a>
                                    <a class="topbar__menu-item" href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/languages/language-4.png" alt="" /><span>Russian</span> </a>
                                    <a class="topbar__menu-item" href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/languages/language-5.png" alt="" /><span>Italian</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z"
                                                ...
                                                <div class="departments__item-menu">
                                                    <div class="megamenu departments__megamenu departments__megamenu--size--xl">
                                                        <div class="megamenu__image"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/departments/departments-2.jpg" alt="" /></div>
                                                        <div class="row">
                                                            <div class="col-1of5">
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z"
                                                ...
                                                <div class="departments__item-menu">
                                                    <div class="megamenu departments__megamenu departments__megamenu--size--lg">
                                                        <div class="megamenu__image"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/departments/departments-1.jpg" alt="" /></div>
                                                        <div class="row">
                                                            <div class="col-3">
                                                                <ul class="megamenu__links megamenu-links megamenu-links--root">
                                                                    <li class="megamenu-links__item megamenu-links__item--has-submenu">
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z"
                                                ...
                                                <div class="departments__item-menu">
                                                    <div class="megamenu departments__megamenu departments__megamenu--size--md">
                                                        <div class="megamenu__image"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/departments/departments-3.jpg" alt="" /></div>
                                                        <div class="row">
                                                            <div class="col-4">
                                                                <ul class="megamenu__links megamenu-links megamenu-links--root">
                                                                    <li class="megamenu-links__item megamenu-links__item--has-submenu">
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z"
                                                ...
                                                <div class="departments__item-menu">
                                                    <div class="megamenu departments__megamenu departments__megamenu--size--nl">
                                                        <div class="megamenu__image"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/departments/departments-4.jpg" alt="" /></div>
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <ul class="megamenu__links megamenu-links megamenu-links--root">
                                                                    <li class="megamenu-links__item megamenu-links__item--has-submenu">
                                                ...
                                                <div class="vehicles-list__body">
                                                    <label class="vehicles-list__item">
                                                        ...
                                                        <span class="vehicles-list__item-info">
                                                            <span class="vehicles-list__item-name">2011 Ford Focus S</span> <span class="vehicles-list__item-details">Engine 2.0L 1742DA L4 FI Turbo</span>
                                                        </span>
                                                    ...
                                                    <label class="vehicles-list__item">
                                                        ...
                                                        <span class="vehicles-list__item-info">
                                                            <span class="vehicles-list__item-name">2019 Audi Q7 Premium</span> <span class="vehicles-list__item-details">Engine 3.0L 5626CC L6 QK</span>
                                                        </span>
                                                        <button type="button" class="vehicles-list__item-remove">
                                                            <svg width="16" height="16"><path d="M2,4V2h3V1h6v1h3v2H2z M13,13c0,1.1-0.9,2-2,2H5c-1.1,0-2-0.9-2-2V5h10V13z" /></svg>
                                                        </button>
                                    ...
                                    <ul class="dropcart__list">
                                        <li class="dropcart__item">
                                            <div class="dropcart__item-image image image--type--product">
                                                <a class="image__body" href="product-full.html"><img class="image__tag" src="<?php echo get_template_directory_uri(); ?>/assets/images/products/product-4-70x70.jpg" alt="" /></a>
                                            </div>
	...
	C9.2,7.8,9.2,8.4,8.8,8.8z"
                                        ...
                                        <li class="dropcart__item">
                                            <div class="dropcart__item-image image image--type--product">
                                                <a class="image__body" href="product-full.html"><img class="image__tag" src="<?php echo get_template_directory_uri(); ?>/assets/images/products/product-2-70x70.jpg" alt="" /></a>
                                            </div>
                                            <div class="dropcart__item-info">
	...
	C9.2,7.8,9.2,8.4,8.8,8.8z"
                                        ...
                                        <li class="dropcart__item">
                                            <div class="dropcart__item-image image image--type--product">
                                                <a class="image__body" href="product-full.html"><img class="image__tag" src="<?php echo get_template_directory_uri(); ?>/assets/images/products/product-5-70x70.jpg" alt="" /></a>
                                            </div>
                                            <div class="dropcart__item-info">
                        ...
                        <div class="block-posts-carousel__carousel">
                            <div class="owl-carousel">
                                <div class="block-posts-carousel__item">
                                    <div class="post-card">
                                        <div class="post-card__image">
                                            <a href="post-full-width.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/posts/post-1-730x485.jpg" alt="" /></a>
                                        </div>
                                ...
                                <div class="block-posts-carousel__item">
                                    <div class="post-card">
                                        <div class="post-card__image">
                                            <a href="post-full-width.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/posts/post-2-730x485.jpg" alt="" /></a>
                                        </div>
                                        <div class="post-card__content">
                                ...
                                <div class="block-posts-carousel__item">
                                    <div class="post-card">
                                        <div class="post-card__image">
                                            <a href="post-full-width.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/posts/post-3-730x485.jpg" alt="" /></a>
                                        </div>
                                        <div class="post-card__content">
                                ...
                                <div class="block-posts-carousel__item">
                                    <div class="post-card">
                                        <div class="post-card__image">
                                            <a href="post-full-width.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/posts/post-4-730x485.jpg" alt="" /></a>
                                        </div>
                                        <div class="post-card__content">
                                            <div class="post-card__category"><a href="blog-classic-right-sidebar.html">Special Offers</a></div>
                                            <div class="post-card__title">
                                ...
                                <div class="block-posts-carousel__item">
                                    <div class="post-card">
                                        <div class="post-card__image">
                                            <a href="post-full-width.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/posts/post-5-730x485.jpg" alt="" /></a>
                                        </div>
                                        <div class="post-card__content">
                                            <div class="post-card__category"><a href="blog-classic-right-sidebar.html">New Arrivals</a></div>
                                            <div class="post-card__title">
                                ...
                                <div class="block-posts-carousel__item">
                                    <div class="post-card">
                                        <div class="post-card__image">
                                            <a href="post-full-width.html"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/posts/post-6-730x485.jpg" alt="" /></a>
                                        </div>
                                        <div class="post-card__content">
                                            <div class="post-card__category"><a href="blog-classic-right-sidebar.html">Special Offers</a></div>
                                            <div class="post-card__title">
                ...
                <div class="block block-brands block-brands--layout--columns-8-full">
                    <div class="container">
                        <ul class="block-brands__list">
                            ...
                            <li class="block-brands__divider" role="presentation"></li>
                            <li class="block-brands__item">
                                <a href="#" class="block-brands__item-link"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brands/brand-3.png" alt="" /> <span class="block-brands__item-name">TurboElectric</span></a>
                            </li>
                            <li class="block-brands__divider" role="presentation"></li>
                            <li class="block-brands__item">
                                <a href="#" class="block-brands__item-link"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brands/brand-4.png" alt="" /> <span class="block-brands__item-name">StartOne</span></a>
                            </li>
                            <li class="block-brands__divider" role="presentation"></li>
                            <li class="block-brands__item">
                                <a href="#" class="block-brands__item-link"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brands/brand-5.png" alt="" /> <span class="block-brands__item-name">Brandix</span></a>
                            </li>
                            <li class="block-brands__divider" role="presentation"></li>
                            <li class="block-brands__item">
                                <a href="#" class="block-brands__item-link"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brands/brand-6.png" alt="" /> <span class="block-brands__item-name">ABS-Brand</span></a>
                            </li>
                            <li class="block-brands__divider" role="presentation"></li>
                            <li class="block-brands__item">
                                <a href="#" class="block-brands__item-link"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brands/brand-7.png" alt="" /> <span class="block-brands__item-name">GreatCircle</span></a>
                            </li>
                            <li class="block-brands__divider" role="presentation"></li>
                            <li class="block-brands__item">
                                <a href="#" class="block-brands__item-link"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brands/brand-8.png" alt="" /> <span class="block-brands__item-name">JustRomb</span></a>
                            </li>
                            <li class="block-brands__divider" role="presentation"></li>
                            <li class="block-brands__item">
                                <a href="#" class="block-brands__item-link"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brands/brand-9.png" alt="" /> <span class="block-brands__item-name">FastWheels</span></a>
                            </li>
                            <li class="block-brands__divider" role="presentation"></li>
                            <li class="block-brands__item">
                                <a href="#" class="block-brands__item-link"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brands/brand-10.png" alt="" /> <span class="block-brands__item-name">Stroyka-X</span></a>
                            </li>
                            <li class="block-brands__divider" role="presentation"></li>
                            <li class="block-brands__item">
                                <a href="#" class="block-brands__item-link"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brands/brand-11.png" alt="" /> <span class="block-brands__item-name">Mission-51</span></a>
                            </li>
                            <li class="block-brands__divider" role="presentation"></li>
                            <li class="block-brands__item">
                                <a href="#" class="block-brands__item-link"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brands/brand-12.png" alt="" /> <span class="block-brands__item-name">FuelCorp</span></a>
                            </li>
                            <li class="block-brands__divider" role="presentation"></li>
                            <li class="block-brands__item">
                                <a href="#" class="block-brands__item-link"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brands/brand-13.png" alt="" /> <span class="block-brands__item-name">RedGate</span></a>
                            </li>
                            <li class="block-brands__divider" role="presentation"></li>
                            <li class="block-brands__item">
                                <a href="#" class="block-brands__item-link"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brands/brand-14.png" alt="" /> <span class="block-brands__item-name">Blocks</span></a>
                            </li>
                            <li class="block-brands__divider" role="presentation"></li>
                            <li class="block-brands__item">
                                <a href="#" class="block-brands__item-link"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/brands/brand-15.png" alt="" /> <span class="block-brands__item-name">BlackBox</span></a>
                            </li>
                            <li class="block-brands__divider" role="presentation"></li>
                            <li class="block-brands__item">
	...
	C11.2,9.8,11.2,10.4,10.8,10.8z"
        ...
        <script src="<?php echo get_template_directory_uri(); ?>/assets/vendor/nouislider/nouislider.min.js"></script>
        <script src="<?php echo get_template_directory_uri(); ?>/assets/vendor/photoswipe/photoswipe.min.js"></script>
        <script src="<?php echo get_template_directory_uri(); ?>/assets/vendor/photoswipe/photoswipe-ui-default.min.js"></script>
        <script src="<?php echo get_template_directory_uri(); ?>/assets/vendor/select2/js/select2.min.js"></script>
        <script src="<?php echo get_template_directory_uri(); ?>/assets/js/number.js"></script>
