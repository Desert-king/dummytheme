...
l0.6-0.6C9.3,2.4,10.3,2,11.3,2c1,0,1.9,0.4,2.6,1.1C15.4,4.6,15.4,6.9,13.9,8.4z"
                            ...
                            <div class="block-zone__widget">
                                <div class="block-zone__widget-header">
                                    <div class="block-zone__tabs">
                                        <button class="tabs-button block-zone__tabs-button--active" target="<?php echo $Cat_1[$x]; ?>" onclick="handleCategoryTabTop(this)">
                                        <!-- <button class="tabs-button" target="<?php echo $Cat_1[$x]; ?>" onclick="handleCategoryTabTop(this)"> -->
                                        <?php 
                                                echo $Cat_1[$x];
                                            ?>
                                        </button>
                                        <button class="tabs-button" target="<?php echo $Cat_2[$x]; ?>" onclick="handleCategoryTabTop(this)">
                                        <?php 
                                                echo $Cat_2[$x];
                                            ?>
                                        </button> 
                                        <button class="tabs-button" target="<?php echo $Cat_3[$x]; ?>" onclick="handleCategoryTabTop(this)">
                                        <?php 
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z"
	 ...
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z"
                                ...
                                <div id="tabPowertrainTop"  class="block-zone__widget-body tab-view-top">
                                    <div class="block-zone__carousel">
                                        <div class="block-zone__carousel-loader"></div>
                                        <div class="owl-carousel">
                                            <?php
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z"
	 ...
	 M3,13h3v2H2c-0.6,0-1-0.4-1-1v-4h2V13z"
                                ...
                                <div id="tabPowertrainMiddle"  class="block-zone__widget-body tab-view-middle">
                                    <div class="block-zone__carousel">
                                        <div class="block-zone__carousel-loader"></div>
                                        <div class="owl-carousel">
                                            <?php
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z"
                                ...
                                <div id="tabPowertrain"  class="block-zone__widget-body tab-view active">
                                    <div class="block-zone__carousel">
                                        <div class="block-zone__carousel-loader"></div>
                                        <div class="owl-carousel">
                                            <?php
                    ...
                    <div class="container">
                        ...
                        <div class="section-header">
                            <div class="section-header__body">
                                ...
                                <div class="section-header__spring"></div>
                                <ul class="section-header__links">
                                    <li class="section-header__links-item"><a class="section-header__links-link" target="tabSpecial" onclick="handleLatestNews(this)">Special Offers</a></li>
                                    <li class="section-header__links-item"><a class="section-header__links-link" target="tabNew" onclick="handleLatestNews(this)">New Arrivals</a></li>
                                    <li class="section-header__links-item"><a class="section-header__links-link" target="tabReview" onclick="handleLatestNews(this)">Reviews</a></li>
                                </ul>
                                <div class="section-header__arrows">
                                    <div class="arrow section-header__arrow section-header__arrow--prev arrow--prev">
                                        <button class="arrow__button" type="button">
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z"
                        ...
                        <div id="tabSpecial" class="block-posts-carousel__carousel latest-news-view active">
                        <div class="owl-carousel">
                                
                                <?php 
                                $args = array( 'post_type' => 'news', 'category_name' => 'Special Offers', 'posts_per_page' => 10 );
                        ...
                        <div id="tabNew" class="block-posts-carousel__carousel latest-news-view">
                        <div class="owl-carousel">
                                
                                <?php 
                                $args = array( 'post_type' => 'news', 'category_name' => 'New Arrivals', 'posts_per_page' => 10 );
                                $the_query = new WP_Query( $args ); 
                                ?>
                                <?php if ( $the_query->have_posts() ) : ?>
                                <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
                        ...
                        <div id="tabReview" class="block-posts-carousel__carousel latest-news-view">
                        <div class="owl-carousel">
                                
                                <?php 
                                $args = array( 'post_type' => 'news', 'category_name' => 'Reviews', 'posts_per_page' => 10 );
                                $the_query = new WP_Query( $args ); 
                                ?>
                                <?php if ( $the_query->have_posts() ) : ?>
                                <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
