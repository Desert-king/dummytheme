...
Redux::setSection( $opt_name,  array(
    'title' => esc_html__('FAQ Page third section contents', 'your-textdomain-here' ),
    'icon' => 'el-icon-thumbs-up',
    'fields' => array(
        array(
            'id'             => 'faq-third-section-fields',
            'type'           => 'repeater',
            ...
            'fields'         => array(
                ...
                array(
                    'id'          => 'faq-third-section-title',
                    'type'        => 'text',
                    'placeholder' => esc_html__( 'Title', 'your-textdomain-here' ),
                ),
                array(
                    'id'               => 'faq-third-section-content',
                    'type'             => 'editor',
