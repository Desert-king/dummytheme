...
Redux::setSection( $opt_name,  array(
    'title' => esc_html__('FAQ Page second section contents', 'your-textdomain-here' ),
    'icon' => 'el-icon-thumbs-up',
    'fields' => array(
        array(
            'id'             => 'faq-second-section-fields',
            'type'           => 'repeater',
            ...
            'fields'         => array(
                ...
                array(
                    'id'          => 'faq-second-section-title',
                    'type'        => 'text',
                    'placeholder' => esc_html__( 'Title', 'your-textdomain-here' ),
                ),
                array(
                    'id'               => 'faq-second-section-content',
                    'type'             => 'editor',
