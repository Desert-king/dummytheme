                                    ...
                                    foreach( wc_get_attribute_taxonomies() as $attribute ) {
                                        ...
                                        if(taxonomy_exists( $taxonomy )){  ?>
                                           ...
                                           ?>" selected>Select <?php echo $term_main; ?></option>
                                                ...
                                                <!-- <span class="select2 select2-container select2-container--default select2-container--disabled select2-container--focus" dir="ltr" data-select2-id="20">
                                                    <span class="selection">
                                                        <span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-disabled="true" aria-labelledby="select2-model-gp-container"><span class="select2-selection__rendered" id="select2-model-gp-container" role="textbox" aria-readonly="true" title="Select Model">
                                                        Select
                                                        </span>
