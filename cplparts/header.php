	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z"
                                ...
                                <?php
                                        wp_nav_menu(    
                                            array(
                                                ...
                                                'items_wrap' => '<ul  id="nav-menu" class="main-menu__list">%3$s</ul>',
                    ...
                    <div class="header__logo">
                        <a href="index.html" class="logo">
                            <?php
                                $cplparts_description = get_bloginfo( 'description', 'display' );
                                if ( $cplparts_description || is_customize_preview() ) :
                            ?>
                            <div class="logo__slogan"><?php echo $cplparts_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></div>
                            <?php endif; ?>
	...
	h-4c-0.6,0-1,0.4-1,1v6c0,0.6,0.4,1,1,1h4c2.2,0,4-1.8,4-4S77.2,5,75,5z"
                       ...
                       <?php
                        ...
                        if ( is_front_page() && is_home() ) :
                            ?>
                            <h1 class="site-title logo__image"><a class="logo__part-secondary" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></h1>
                            <?php
                        else :
                            ?>
                            <p class="site-title logo__image"><a  class="logo__part-secondary" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></p>
                            <?php
                        endif;
                        $cplparts_description = get_bloginfo( 'description', 'display' );
                        if ( $cplparts_description || is_customize_preview() ) :
                            ?>
                            <p class="site-description"><?php//echo $cplparts_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
                        <?php endif; ?>
                        </div>
                    <!-- </div> -->
