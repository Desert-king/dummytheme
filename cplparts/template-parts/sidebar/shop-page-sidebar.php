...
C6.1,7.8,6.1,8.4,5.7,8.7z"
                        ...
                        <?php 
                            ...
                            //    $product_attributes = array('pa_brand', 'pa_color', 'pa_vehicle');
                            //    $attr_output = array();
                            
                            //    foreach( $product_attributes as $taxonomy ){
                            //    if( taxonomy_exists($taxonomy) ){
                            //    $label_name = get_taxonomy( $taxonomy )->labels->singular_name;
                            //    $value1 = $product->get_attribute('pa_brand');
                            //    $value2 = $product->get_attribute('pa_color');
                            //    $value3 = $product->get_attribute('pa_vehicle');
                            
                               
                            //    if( ! empty($value1) ){
                           
                            //    $attr_output[] = "<span class=”'.$taxonomy.'”>'.$label_name.': '.$value1.'</span>";
                            //    }
                            //    }
                            //    }
